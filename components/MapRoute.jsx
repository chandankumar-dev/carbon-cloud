...
function MapRoute({ route, setSelectedRoute, selected }) {
  ...
  return (
    ...
    <button
      className={`py-2 grid grid-cols-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 hover:bg-gray-100 hover:text-black  transition-all duration-300 hover:shadow-lg rounded-2xl ${
